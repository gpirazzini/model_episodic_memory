...
% load <<INSERT YOUR DIRECTORY HERE>> ... synapses_ORTHO
...
plot(t,(zp2(ep2,:)),'Color',[255 128 0]/255,'LineWidth',0.5)
plot(t,(zp2(ep3,:)),'g','LineWidth',0.5)
...
plot(t,(zp2(ep7,:)),'--','Color',[255 128 0]/255,'LineWidth',0.5)
plot(t,(zp2(ep8,:)),'g--','LineWidth',0.5)
plot(t,(zp2(ep9,:)),'r--','LineWidth',0.5)
plot(t,(zp2(ep10,:)),'k--','LineWidth',0.5)
legend('ep6','','','','ep7','','','','','','ep8','','','','','ep9','','','','','','ep10','','','')
xlim([0.52 0.7])
ylim([0 5]), yticks([1:5])

subplot(3,1,3), hold on, ylabel('Zp (Hz)'), xlabel('time (s)')
plot(t,(zp2(ep11,:)),'b:','LineWidth',1)
plot(t,(zp2(ep12,:)),':','Color',[255 128 0]/255,'LineWidth',1)
plot(t,(zp2(ep13,:)),'g:','LineWidth',1)
plot(t,(zp2(ep14,:)),'r:','LineWidth',1)
plot(t,(zp2(ep15,:)),'k:','LineWidth',1)
legend('ep11','','','','ep12','','','','','','ep13','','','','','ep14','','','','','','ep15','','','')
xlim([1.25 1.42])
ylim([0 5]), yticks([1:5])
